...
@app.route('/wall')
def wall():
    query = 'SELECT messages.message, messages.id, messages.created_at, users.first_name, users.last_name FROM messages JOIN users ON messages.user_id = users.id ORDER BY messages.created_at DESC'
    messages = mysql.query_db(query)
    query = 'SELECT comments.comment, comments.user_id, comments.message_id, comments.created_at, users.first_name, users.last_name FROM comments JOIN users ON comments.user_id = users.id'
